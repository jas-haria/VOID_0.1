...
CREATE TABLE IF NOT EXISTS QUORA_KEYWORDS (
    ...
    CONSTRAINT PK_QUORA_KEYWORDS PRIMARY KEY (KEYWORD),
...
INSERT INTO SCRIPTS (SCRIPT_NAME) VALUES ('Refresh_Quora_Stats'), ('Refresh_Quora_Questions_Table');

INSERT INTO EXECUTION_LOG (SCRIPT_ID, EXECUTION_TIME)
SELECT ID, DATE_ADD(NOW(), INTERVAL -10 DAY) FROM SCRIPTS;
